package org.onosproject.mlrouting.rest;
 ...
 */
@Path("ml-routing")
public class MLRestResource extends AbstractWebResource {

    private MLRoutingService MLRoutingService = get(MLRoutingService.class);
