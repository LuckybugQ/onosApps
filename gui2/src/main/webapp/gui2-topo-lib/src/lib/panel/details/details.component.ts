...
import { DetailsPanelBaseImpl, FnService, LogService, WebSocketService, LionService } from '../../../../../gui2-fw-lib/src/public_api';
    ...
    ngOnChanges(changes: SimpleChanges): void {
        if (changes['selectedNodes']) {
            ...
            if (selectedNode.hasOwnProperty('nodeType')) { // For Device, Host, SubRegion
                ...
                this.showDetails = <ShowDetails>{};
                this.showDetails.glyphId = 'switch'
                this.showDetails.propLabels = {'1.1':'URI','1.2':'Protocol','-':'-','2':'Ports','3':'Flows'}
                this.showDetails.propValues = {'1.1':'of:0000000000000001','1.2':'OF_13','2':3,'3':0}
                this.showDetails.propOrder = ['1.1','1.2','-','2','3']
                this.showDetails.title = 'of:0000000000000001'
                this.showDetails.buttons = ['portTable','flowTable','groupTable','meterTable','m_flows','m_relatedIntents']
