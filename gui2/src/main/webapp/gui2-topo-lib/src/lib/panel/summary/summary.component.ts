...
import { FnService, LogService, WebSocketService, GlyphService } from '../../../../../gui2-fw-lib/src/public_api';
...
export class SummaryComponent extends TopoPanelBaseImpl implements OnInit, OnDestroy {
    ...
    private render() {
        ...
        this.gs.addGlyph(svg, 'm_satellite', 24, 0, [1, 1]);

        
        this.addProp(tbody,'Version',1.01)
        this.addSep(tbody)
        this.addProp(tbody,'Devices',28)
        this.addProp(tbody,'Links',57)
        this.addProp(tbody,'Hosts',0)
